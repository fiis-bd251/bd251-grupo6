...
**¿Cómo se podrían fijar o sea o cómo harían para ver si la disponibilidad de estos productos se encuentran no o sea están 100% disponibles o o cómo o cómo que por ejemplo quién informa quién para saber o algo así?**

Brian recibió, Eric almacenó y Eric como dueño del almacén reporta a diario semanal los stocks de los productos según sea el estado. Eric reporta hacia Gabriel y le dice los stocks disponibles y no disponibles. Gabriel, de acuerdo al stock compartido, hace su planning hacia producción.

**Alguna vez no hubo algún error por ejemplo al decir ¿no que sí había la disponibilidad del de tal producto pero al final se dieron cuenta de que no y si es que tuvieron ese digamos inconveniente ¿cómo lo pudieron resolver esa esa información me gustaría saberla?**

Puede haber un error en el ingreso de cantidades. En ese caso, el almacén tiene que hacer la separación o el informe indicando el error. Se puede pasar el excedente a no disponible o anular el ingreso y volver a hacerlo correctamente, dependiendo si el proveedor volverá pronto.
