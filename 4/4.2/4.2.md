...
| **Atributo**             | **Naturaleza**   | **Formato**     | **Valores Válidos**                    | **Unidad**     | **Derivada de**            | **Descripción**                                       |
|--------------------------|------------------|-----------------|----------------------------------------|---------------|----------------------------|-------------------------------------------------------|
| ID Ubicación             | Clave Primaria   | INT             | Único para cada ubicación             | N/A           | N/A                        | Identificador único de la ubicación dentro del almacén.|
| Descripción              | Atributo         | CHAR(100)       | Nombre de la ubicación                | N/A           | N/A                        | Descripción o nombre de la ubicación (ej. Pasillo A). |
| Tipo de Ubicación        | Atributo         | CHAR(50)        | 'Refrigerada', 'Normal', 'Alta rotación'| N/A           | N/A                        | Tipo de ubicación según el uso de la zona del almacén.|
| Capacidad                | Atributo         | FLOAT           | Capacidad máxima de productos         | Unidades      | N/A                        | Capacidad total que puede contener la ubicación.     |
| Estado                   | Atributo         | CHAR(20)        | 'Disponible', 'Ocupado', 'Reservado'  | N/A           | N/A                        | Estado de la ubicación (disponible, ocupada, etc.).  |
